...
static HAL_StatusTypeDef RCCEx_PLLSAI1_Config(RCC_PLLSAI1InitTypeDef *pPllSai1,
		uint32_t Divider);
static uint32_t RCCEx_PLLSAI1_GetVCOFreq(void);
static HAL_StatusTypeDef RCCEx_PLLSAI2_Config(RCC_PLLSAI2InitTypeDef *pPllSai2,
		uint32_t Divider);
...
void HAL_RCCEx_GetPeriphCLKConfig(RCC_PeriphCLKInitTypeDef *PeriphClkInit) {
	...
	PeriphClkInit->PeriphClockSelection = RCC_PERIPHCLK_USART1
			...
			| RCC_PERIPHCLK_USB | RCC_PERIPHCLK_DFSDM1 |
			RCC_PERIPHCLK_DFSDM1AUDIO | RCC_PERIPHCLK_RTC | RCC_PERIPHCLK_OSPI
			| RCC_PERIPHCLK_FDCAN;

	/* Get the PLLSAI1 Clock configuration -----------------------------------------------*/
	PeriphClkInit->PLLSAI1.PLLSAI1Source = (uint32_t) ((RCC->PLLSAI1CFGR
			& RCC_PLLSAI1CFGR_PLLSAI1SRC) >> RCC_PLLSAI1CFGR_PLLSAI1SRC_Pos);
	PeriphClkInit->PLLSAI1.PLLSAI1M = (uint32_t) ((RCC->PLLSAI1CFGR
			& RCC_PLLSAI1CFGR_PLLSAI1M) >> RCC_PLLSAI1CFGR_PLLSAI1M_Pos) + 1U;
	PeriphClkInit->PLLSAI1.PLLSAI1N = (uint32_t) ((RCC->PLLSAI1CFGR
			& RCC_PLLSAI1CFGR_PLLSAI1N) >> RCC_PLLSAI1CFGR_PLLSAI1N_Pos);
	PeriphClkInit->PLLSAI1.PLLSAI1P = (uint32_t) (((RCC->PLLSAI1CFGR
			& RCC_PLLSAI1CFGR_PLLSAI1P) >> RCC_PLLSAI1CFGR_PLLSAI1P_Pos) << 4U)
			+ 7U;
	PeriphClkInit->PLLSAI1.PLLSAI1Q = (uint32_t) (((RCC->PLLSAI1CFGR
			& RCC_PLLSAI1CFGR_PLLSAI1Q) >> RCC_PLLSAI1CFGR_PLLSAI1Q_Pos) + 1U)
			* 2U;
	PeriphClkInit->PLLSAI1.PLLSAI1R = (uint32_t) (((RCC->PLLSAI1CFGR
			& RCC_PLLSAI1CFGR_PLLSAI1R) >> RCC_PLLSAI1CFGR_PLLSAI1R_Pos) + 1U)
			* 2U;

	/* Get the PLLSAI2 Clock configuration -----------------------------------------------*/
	PeriphClkInit->PLLSAI2.PLLSAI2Source = (uint32_t) ((RCC->PLLSAI2CFGR
			& RCC_PLLSAI2CFGR_PLLSAI2SRC) >> RCC_PLLSAI2CFGR_PLLSAI2SRC_Pos);
	PeriphClkInit->PLLSAI2.PLLSAI2M = (uint32_t) ((RCC->PLLSAI2CFGR
			& RCC_PLLSAI2CFGR_PLLSAI2M) >> RCC_PLLSAI2CFGR_PLLSAI2M_Pos) + 1U;
	PeriphClkInit->PLLSAI2.PLLSAI2N = (uint32_t) ((RCC->PLLSAI2CFGR
			& RCC_PLLSAI2CFGR_PLLSAI2N) >> RCC_PLLSAI2CFGR_PLLSAI2N_Pos);
	PeriphClkInit->PLLSAI2.PLLSAI2P = (uint32_t) (((RCC->PLLSAI2CFGR
			& RCC_PLLSAI2CFGR_PLLSAI2P) >> RCC_PLLSAI2CFGR_PLLSAI2P_Pos) << 4U)
			+ 7U;
	...
	if (PeriphClk == RCC_PERIPHCLK_RTC) {
		...
		case RCC_PERIPHCLK_SDMMC1:
			...
			} else /* 48MHz from MSI or PLLSAI1Q or PLLQ or HSI48 */
			{
				...
				case RCC_CCIPR1_CLK48MSEL: /* MSI ? */
					if (HAL_IS_BIT_SET(RCC->CR, RCC_CR_MSIRDY)) {
						/*MSI frequency range in HZ*/
						frequency = MSIRangeTable[(__HAL_RCC_GET_MSI_RANGE()
								>> 4U)];
					}
					break;
				case RCC_CCIPR1_CLK48MSEL_1: /* PLL "Q" ? */
		...
		case RCC_PERIPHCLK_ADC:
			...
			case RCC_ADCCLKSOURCE_PLLSAI1:
				if (__HAL_RCC_GET_PLLSAI1CLKOUT_CONFIG(RCC_PLLSAI1_ADC1CLK)
						!= 0U) {
					/* Get f(PLLSAI1 source) */
					pllvco = RCCEx_PLLSAI1_GetVCOFreq();
					/* f(PLLSAI1 Source) / PLLSAI1M */
		...
		case RCC_PERIPHCLK_FDCAN:
			...
			case RCC_FDCANCLKSOURCE_PLLSAI1:
				if (__HAL_RCC_GET_PLLSAI1CLKOUT_CONFIG(RCC_PLLSAI1_SAI1CLK)
						!= 0U) {
					/* Get f(PLLSAI1 source) */
					pllvco = RCCEx_PLLSAI1_GetVCOFreq();
					/* f(PLLSAI1 Source) / PLLSAI1M */
					...
					pllp =
							READ_BIT(RCC->PLLSAI1CFGR,
									RCC_PLLSAI1CFGR_PLLSAI1PDIV) >> RCC_PLLSAI1CFGR_PLLSAI1PDIV_Pos;
					if (pllp == 0U) {
...
HAL_StatusTypeDef HAL_RCCEx_EnablePLLSAI1(RCC_PLLSAI1InitTypeDef *PLLSAI1Init) {
	...
	if (status == HAL_OK) {
		...
		if (status == HAL_OK) {
			...
			__HAL_RCC_PLLSAI1_CONFIG(PLLSAI1Init->PLLSAI1Source,
...
HAL_StatusTypeDef HAL_RCCEx_EnablePLLSAI2(RCC_PLLSAI2InitTypeDef *PLLSAI2Init) {
	...
	if (status == HAL_OK) {
		...
		if (status == HAL_OK) {
			...
			__HAL_RCC_PLLSAI2_CONFIG(PLLSAI2Init->PLLSAI2Source,
...
void HAL_RCCEx_CRSGetSynchronizationInfo(
	...
	pSynchroInfo->ReloadValue =
			(uint32_t) (READ_BIT(CRS->CFGR, CRS_CFGR_RELOAD));

	/* Get HSI48 oscillator smooth trimming */
	pSynchroInfo->HSI48CalibrationValue =
			(uint32_t) (READ_BIT(CRS->CR, CRS_CR_TRIM) >> CRS_CR_TRIM_Pos);

	/* Get Frequency error capture */
	pSynchroInfo->FreqErrorCapture =
			(uint32_t) (READ_BIT(CRS->ISR, CRS_ISR_FECAP) >> CRS_ISR_FECAP_Pos);

	/* Get Frequency error direction */
	pSynchroInfo->FreqErrorDirection = (uint32_t) (READ_BIT(CRS->ISR,
			CRS_ISR_FEDIR));
}
		...
		if (status == HAL_OK) {
			if (Divider == DIVIDER_P_UPDATE) {
				...
				MODIFY_REG(RCC->PLLSAI1CFGR,
						...
						(pPllSai1->PLLSAI1N << RCC_PLLSAI1CFGR_PLLSAI1N_Pos) | (pPllSai1->PLLSAI1P << RCC_PLLSAI1CFGR_PLLSAI1PDIV_Pos) | ((pPllSai1->PLLSAI1M - 1U) << RCC_PLLSAI1CFGR_PLLSAI1M_Pos) | pPllSai1->PLLSAI1Source);
				...
				MODIFY_REG(RCC->PLLSAI1CFGR,
						...
						(pPllSai1->PLLSAI1N << RCC_PLLSAI1CFGR_PLLSAI1N_Pos) | (((pPllSai1->PLLSAI1Q >> 1U) - 1U) << RCC_PLLSAI1CFGR_PLLSAI1Q_Pos) | ((pPllSai1->PLLSAI1M - 1U) << RCC_PLLSAI1CFGR_PLLSAI1M_Pos) | pPllSai1->PLLSAI1Source);
			} else {
				...
				MODIFY_REG(RCC->PLLSAI1CFGR,
						...
						(pPllSai1->PLLSAI1N << RCC_PLLSAI1CFGR_PLLSAI1N_Pos) | (((pPllSai1->PLLSAI1R >> 1U) - 1U) << RCC_PLLSAI1CFGR_PLLSAI1R_Pos) | ((pPllSai1->PLLSAI1M - 1U) << RCC_PLLSAI1CFGR_PLLSAI1M_Pos) | pPllSai1->PLLSAI1Source);
			}
		...
		if (status == HAL_OK) {
			if (Divider == DIVIDER_P_UPDATE) {
				...
				MODIFY_REG(RCC->PLLSAI2CFGR,
						...
						(pPllSai2->PLLSAI2N << RCC_PLLSAI2CFGR_PLLSAI2N_Pos) | (pPllSai2->PLLSAI2P << RCC_PLLSAI2CFGR_PLLSAI2PDIV_Pos) | ((pPllSai2->PLLSAI2M - 1U) << RCC_PLLSAI2CFGR_PLLSAI2M_Pos) | pPllSai2->PLLSAI2Source);
			...
			if (__HAL_RCC_GET_PLLSAI1CLKOUT_CONFIG(RCC_PLLSAI1_SAI1CLK) != 0U) {
				...
				pllvco = (pllvco
						/ ((READ_BIT(RCC->PLLSAI1CFGR, RCC_PLLSAI1CFGR_PLLSAI1M)
								>> RCC_PLLSAI1CFGR_PLLSAI1M_Pos) + 1U));
				/* f(PLLSAI1CLK) = f(VCOSAI1 input) * PLLSAI1N / PLLSAI1P */
				plln =
						READ_BIT(RCC->PLLSAI1CFGR,
								RCC_PLLSAI1CFGR_PLLSAI1N) >> RCC_PLLSAI1CFGR_PLLSAI1N_Pos;
			...
			if (__HAL_RCC_GET_PLLSAI2CLKOUT_CONFIG(RCC_PLLSAI2_SAI2CLK) != 0U) {
				...
				pllvco = (pllvco
						/ ((READ_BIT(RCC->PLLSAI2CFGR, RCC_PLLSAI2CFGR_PLLSAI2M)
								>> RCC_PLLSAI2CFGR_PLLSAI2M_Pos) + 1U));
				...
				pllp =
						READ_BIT(RCC->PLLSAI2CFGR,
								RCC_PLLSAI2CFGR_PLLSAI2PDIV) >> RCC_PLLSAI2CFGR_PLLSAI2PDIV_Pos;
				if (pllp == 0U) {
