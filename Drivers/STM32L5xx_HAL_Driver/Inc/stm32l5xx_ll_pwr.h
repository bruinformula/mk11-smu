...
#define LL_PWR_ReadReg(__REG__) READ_REG(PWR->__REG__)
	...
	__STATIC_INLINE uint32_t LL_PWR_IsEnabledSMPSLowPowerMode(void) {
		return ((READ_BIT(PWR->CR4, PWR_CR4_SMPSLPEN) == (PWR_CR4_SMPSLPEN)) ?
				1UL : 0UL);
	}
	...
	__STATIC_INLINE uint32_t LL_PWR_IsEnabledSMPSFastStart(void) {
		return ((READ_BIT(PWR->CR4, PWR_CR4_SMPSFSTEN) == (PWR_CR4_SMPSFSTEN)) ?
				1UL : 0UL);
	}
	...
	__STATIC_INLINE uint32_t LL_PWR_IsEnabledSMPSBypassMode(void) {
		return ((READ_BIT(PWR->CR4, PWR_CR4_SMPSBYP) == (PWR_CR4_SMPSBYP)) ?
				1UL : 0UL);
	}
	...
	__STATIC_INLINE uint32_t LL_PWR_IsEnabledExtSMPS(void) {
		return ((READ_BIT(PWR->CR4, PWR_CR4_EXTSMPSEN) == (PWR_CR4_EXTSMPSEN)) ?
				1UL : 0UL);
	}
	...
	__STATIC_INLINE uint32_t LL_PWR_IsEnabledUltraLowPowerMode(void) {
		return ((READ_BIT(PWR->CR3, PWR_CR3_ULPMEN) == (PWR_CR3_ULPMEN)) ?
				1UL : 0UL);
	}
	...
	__STATIC_INLINE uint32_t LL_PWR_IsActiveFlag_SMPSHPRDY(void) {
		return ((READ_BIT(PWR->SR1, PWR_SR1_SMPSHPRDY) == (PWR_SR1_SMPSHPRDY)) ?
				1UL : 0UL);
	}
	...
	__STATIC_INLINE uint32_t LL_PWR_IsActiveFlag_EXTSMPSRDY(void) {
		return ((READ_BIT(PWR->SR1, PWR_SR1_EXTSMPSRDY) == (PWR_SR1_EXTSMPSRDY)) ?
				1UL : 0UL);
	}
	...
	__STATIC_INLINE uint32_t LL_PWR_IsActiveFlag_SMPSBYPRDY(void) {
		return ((READ_BIT(PWR->SR1, PWR_SR1_SMPSBYPRDY) == (PWR_SR1_SMPSBYPRDY)) ?
				1UL : 0UL);
	}
	...
	__STATIC_INLINE uint32_t LL_PWR_IsEnabledPrivilege(void) {
		return ((READ_BIT(PWR->PRIVCFGR, PWR_PRIVCFGR_PRIV) == PWR_PRIVCFGR_PRIV) ?
				1UL : 0UL);
	}
