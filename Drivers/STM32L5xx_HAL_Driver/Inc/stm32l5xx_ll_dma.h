 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_DMA_IsEnabledDoubleBufferMode(DMA_TypeDef *DMAx,
		uint32_t Channel) {
	uint32_t dma_base_addr = (uint32_t) DMAx;
	return ((READ_BIT(((DMA_Channel_TypeDef *)(dma_base_addr + CHANNEL_OFFSET_TAB[Channel]))->CCR,
...
__STATIC_INLINE void LL_DMA_SetCurrentTargetMem(DMA_TypeDef *DMAx,
		uint32_t Channel, uint32_t CurrentMemory) {
	uint32_t dma_base_addr = (uint32_t) DMAx;
	MODIFY_REG(
			((DMA_Channel_TypeDef* )(dma_base_addr + CHANNEL_OFFSET_TAB[Channel]))->CCR,
			DMA_CCR_CT, CurrentMemory);
}
 ...
 * @retval None
 */
__STATIC_INLINE void LL_DMA_EnableChannelPrivilege(DMA_TypeDef *DMAx,
		uint32_t Channel) {
	uint32_t dma_base_addr = (uint32_t) DMAx;
	SET_BIT(
			((DMA_Channel_TypeDef* )(dma_base_addr + CHANNEL_OFFSET_TAB[Channel]))->CCR,
 ...
 * @retval None
 */
__STATIC_INLINE void LL_DMA_DisableChannelPrivilege(DMA_TypeDef *DMAx,
		uint32_t Channel) {
	uint32_t dma_base_addr = (uint32_t) DMAx;
	CLEAR_BIT(
			((DMA_Channel_TypeDef* )(dma_base_addr + CHANNEL_OFFSET_TAB[Channel]))->CCR,
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_DMA_IsEnabledChannelPrivilege(DMA_TypeDef *DMAx,
		uint32_t Channel) {
	uint32_t dma_base_addr = (uint32_t) DMAx;
	return ((READ_BIT(((DMA_Channel_TypeDef *)(dma_base_addr + CHANNEL_OFFSET_TAB[Channel]))->CCR,
...
__STATIC_INLINE void LL_DMA_ConfigAddresses(DMA_TypeDef *DMAx, uint32_t Channel,
	...
	if (Direction == LL_DMA_DIRECTION_MEMORY_TO_PERIPH) {
		WRITE_REG(
				((DMA_Channel_TypeDef* )(dma_base_addr
						+ CHANNEL_OFFSET_TAB[Channel]))->CM0AR, SrcAddress);
		WRITE_REG(
				((DMA_Channel_TypeDef* )(dma_base_addr
	...
	/* Direction Periph to Memory and Memory to Memory */
		...
		WRITE_REG(
				((DMA_Channel_TypeDef* )(dma_base_addr
						+ CHANNEL_OFFSET_TAB[Channel]))->CM0AR, DstAddress);
	}
}
...
__STATIC_INLINE void LL_DMA_SetMemoryAddress(DMA_TypeDef *DMAx,
	...
	uint32_t dma_base_addr = (uint32_t) DMAx;
	WRITE_REG(
			((DMA_Channel_TypeDef* )(dma_base_addr + CHANNEL_OFFSET_TAB[Channel]))->CM0AR,
			MemoryAddress);
}
...
__STATIC_INLINE void LL_DMA_SetMemory1Address(DMA_TypeDef *DMAx,
	...
	uint32_t dma_base_addr = (uint32_t) DMAx;
	WRITE_REG(
			((DMA_Channel_TypeDef* )(dma_base_addr + CHANNEL_OFFSET_TAB[Channel]))->CM1AR,
			MemoryAddress);
}
