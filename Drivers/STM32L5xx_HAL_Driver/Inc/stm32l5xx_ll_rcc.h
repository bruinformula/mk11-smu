  ...
  (((__MSISEL__) == LL_RCC_MSIRANGESEL_STANDBY) ? \
   ...
   MSIRangeTable[((__MSIRANGE__) >> RCC_CR_MSIRANGE_Pos) & 0x0FU])
	...
	__STATIC_INLINE void LL_RCC_SetUSARTClockSource(uint32_t USARTxSource) {
		MODIFY_REG(RCC->CCIPR1, (USARTxSource >> 16U),
	...
	__STATIC_INLINE void LL_RCC_SetUARTClockSource(uint32_t UARTxSource) {
		MODIFY_REG(RCC->CCIPR1, (UARTxSource >> 16U),
	...
	__STATIC_INLINE void LL_RCC_SetI2CClockSource(uint32_t I2CxSource) {
		__IO uint32_t *reg = (__IO uint32_t*) (uint32_t) (RCC_BASE + 0x88U
				+ (I2CxSource >> 24U));
		MODIFY_REG(*reg, 3U << (((I2CxSource & 0x00FF0000U) >> 16U) & 0x1FU),
				((I2CxSource & 0x000000FFU)
						<< (((I2CxSource & 0x00FF0000U) >> 16U) & 0x1FU)));
	}
	...
	__STATIC_INLINE void LL_RCC_SetLPTIMClockSource(uint32_t LPTIMxSource) {
		MODIFY_REG(RCC->CCIPR1, (LPTIMxSource & 0xFFFF0000U),
				(LPTIMxSource << 16U));
	}
	...
	__STATIC_INLINE void LL_RCC_SetSAIClockSource(uint32_t SAIxSource) {
		MODIFY_REG(RCC->CCIPR2, (SAIxSource >> 16U),
				(SAIxSource & 0x0000FFFFU));
	}
	...
	__STATIC_INLINE uint32_t LL_RCC_GetI2CClockSource(uint32_t I2Cx) {
		...
		return (uint32_t) ((READ_BIT(*reg,
				(3UL << (((I2Cx & 0x00FF0000UL) >> 16U) & 0x1FUL)))
	...
	__STATIC_INLINE uint32_t LL_RCC_PLLSAI1_GetSource(void) {
		return (uint32_t) (READ_BIT(RCC->PLLSAI1CFGR,
				RCC_PLLSAI1CFGR_PLLSAI1SRC));
	}
	...
	__STATIC_INLINE uint32_t LL_RCC_PLLSAI2_GetSource(void) {
		return (uint32_t) (READ_BIT(RCC->PLLSAI2CFGR,
				RCC_PLLSAI2CFGR_PLLSAI2SRC));
	}
